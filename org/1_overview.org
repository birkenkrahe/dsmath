...
* DONE Course syllabus (on GitHub and on Canvas)
#+attr_html: :width 500px
...
* TODO Course "learning" platform: Canvas
...
* TODO Course topics (illustrated)
...
#+end_notes
* TODO Course topics (spelled out)
#+attr_html: :width 500px
...
* TODO Agile team project (with "Scrum")
...
* TODO Many project opportunities
