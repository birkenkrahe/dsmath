...
- [ ] 1654: [[https://web.universiteitleiden.nl/fsw/verduin/stathist/sh_17.htm][letters between Blaise Pascal and Pierre de Fermat]]
- [ ] Featured application: [[https://retractionwatch.com/retraction-watch-database-user-guide/retraction-watch-database-user-guide-appendix-b-reasons/][retraction watch]]
- [ ] Review: test 4
- [ ] Review: DataCamp lesson probability and distributions
- [ ] Practice: statistical variables (continued)
- [ ] Lecture/practice: summary statistics
- [ ] Off-topic: [[https://github.com/birkenkrahe/dsmath/issues/38][Laporta algorithm (Feynman diagram evaluation)]]

** TODO Review: test 4 - raw data, probability and stats

- [ ] Longitude/latitude are what kind of data?
- [ ] When researching, do you always need a "literature review"?
- [ ] Which activities connect "population" and "sample"?

** TODO Review: probability and distributions (DataCamp)

1) What is the probability for an event B given that an event A has
   already happened.
   #+begin_notes
...
** IN PROGRESS Raw data: statistical variables (practice)
** TODO Lecture/practice: summary statistics
