...
- [ ] *Don't go to class* on Thursday October 13 - instead:
- [ ] *Complete Test 7*: DataCamp review (Oct 13)
...
- Special incentive: *no class on Thursday morning* (test instead) so
  that you can be there at least from 9-9.30 AM if you have no class
...
* TODO Review: Tukey's Five-Point Stats Summary
#+attr_html: :width 300px
[[../img/review.jpg]]
...
2) A data scientist runs the code below on the ~faithful~ data set. What
   is this data scientist likely /interested in/?
   #+begin_src R
...
* TODO Review: Central Limit Theorem/Stats Tests
* References
#+attr_html: :width 500px
[[../img/books.jpg]]
