...
*Note:* the last two DataCamp home assignments ("Bayesian statistics"
and "Related distributions") are not part of the final exam.

*Selection of quiz questions (__/___) from the final exam (40/__):*
