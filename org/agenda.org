...
- [ ] Featured: [[https://retractionwatch.com/retraction-watch-database-user-guide/retraction-watch-database-user-guide-appendix-b-reasons/][retraction watch]]
- [ ] Review: test 4
...
1) What is the probability for an event B given that an event A has
   already happened? (E.g. selecting special orders over $150 from a
   larger sample of orders.)
