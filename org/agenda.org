...
** DONE Review: test 4 - raw data, probability and stats
...
** DONE Review: probability and distributions (DataCamp)
...
** DONE Raw data: statistical variables (practice)
* Stats news: university ranking ([[https://github.com/birkenkrahe/dsmath/issues/39][issue]])
...
#+begin_src R
  ...
  chickwts$weight[which(chickwts$feed == "soybean")]
#+end_src
...
* Week 6: 
** TODO Review: DataCamp - Central Limit Theorem
* References
